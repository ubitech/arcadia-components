package eu.arcadia.maestro.trascodingworkerfour.impl;
...
import eu.arcadia.maestro.trascodingworkerfour.util.IpHandlingUtil;
 ...
 */
@ArcadiaComponent(
        componentname = "TrascodingWorkerFour",
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "trascodingworkerfour", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
     ...
     * @param chainingInfo ChainingInfo object
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "trascodingworkerfour")
