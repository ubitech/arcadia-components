package eu.arcadia.maestro.persistenceengine.impl;
...
import eu.arcadia.maestro.persistenceengine.util.IpHandlingUtil;
 ...
 *
 */
@ArcadiaComponent(componentname = "PersistenceEngine",
        componentversion = "0.1.0",
        componentdescription = "A Persistence Engine component created for Arcadia.",
        tags = {"Arcadia", "component", "Arcadia Pilot", "PersistenceEngine"})
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "persistenceengine", allowsMultipleTenants = true)
...
public class WrappedComponent {
     ...
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "persistanceengine")
