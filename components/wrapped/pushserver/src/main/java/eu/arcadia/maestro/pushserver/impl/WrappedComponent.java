package eu.arcadia.maestro.pushserver.impl;
...
import eu.arcadia.maestro.pushserver.util.IpHandlingUtil;
 ...
 *
 */
@ArcadiaComponent(componentname = "PushServer",
        componentversion = "0.1.0",
        componentdescription = "A Push Server component created for Arcadia.",
        tags = {"Arcadia", "component", "Arcadia Pilot", "PushServer"})
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "pushserver", allowsMultipleTenants = true)
...
public class WrappedComponent {
     ...
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "pushserver")
