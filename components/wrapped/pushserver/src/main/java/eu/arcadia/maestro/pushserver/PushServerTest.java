package eu.arcadia.maestro.pushserver;

import eu.arcadia.maestro.api.MetricsProvider;
import eu.arcadia.maestro.pushserver.impl.PushServerMetricsProvider;
import eu.arcadia.maestro.pushserver.util.Metric;
...
public class PushServerTest {
    public static void main(String[] args) {
        //Instantiate
        MetricsProvider metricsProvider = new PushServerMetricsProvider();
