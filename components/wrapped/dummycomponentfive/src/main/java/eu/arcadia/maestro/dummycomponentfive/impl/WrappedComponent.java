package eu.arcadia.maestro.dummycomponentfive.impl;
...
import eu.arcadia.maestro.dummycomponentfive.util.IpHandlingUtil;
 ...
 *
 */
@ArcadiaComponent(componentname = "DummyComponentFive",
        componentversion = "0.1.0",
        componentdescription = "A dummy component created for Arcadia demonstration purposes.",
        tags = {"Arcadia", "component", "Arcadia Pilot", "alpine", "DummyComponentFive"})
...
public class WrappedComponent {
    ...
    public static String getDummycomponentsixuri() {
        return System.getProperty("dummycomponentsixuri");

    }

    public static String getDummycomponentsixport() {
        return System.getProperty("dummycomponentsixport");
     ...
     */
    @ArcadiaChainableEndpointBindingHandler(CEPCID = "dummycomponentsix")
     ...
     * @param chainingInfo ChainingInfo object
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "dummycomponentfive")
