package eu.arcadia.maestro.trascodingworkertwo.impl;
...
import eu.arcadia.maestro.trascodingworkertwo.util.IpHandlingUtil;
 ...
 */
@ArcadiaComponent(
        componentname = "TrascodingWorkerTwo",
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "trascodingworkertwo", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
     ...
     * @param chainingInfo ChainingInfo object
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "trascodingworkertwo")
