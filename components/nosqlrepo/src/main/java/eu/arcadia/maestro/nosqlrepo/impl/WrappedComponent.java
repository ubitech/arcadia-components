package eu.arcadia.maestro.nosqlrepo.impl;
...
import eu.arcadia.maestro.nosqlrepo.util.IpHandlingUtil;
 ...
 */
@ArcadiaComponent(
        componentname = "NoSQLRepo",
        componentversion = "0.1.0",
        componentdescription = "A NoSQLRepo component created for Arcadia demonstration purposes.",
        tags = {"Arcadia", "component", "Arcadia Pilot", "alpine", "NoSQLRepo"})
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "nosqlrepo", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
     ...
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "nosqlrepo")
