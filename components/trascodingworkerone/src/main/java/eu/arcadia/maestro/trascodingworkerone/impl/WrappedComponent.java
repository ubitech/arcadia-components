package eu.arcadia.maestro.trascodingworkerone.impl;
...
import eu.arcadia.maestro.trascodingworkerone.util.IpHandlingUtil;
 ...
 */
@ArcadiaComponent(
        componentname = "TrascodingWorkerOne",
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "trascodingworkerone", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
     ...
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "trascodingworkerone")
