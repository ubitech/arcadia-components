package eu.arcadia.maestro.trascodingworkerthree.impl;
...
import eu.arcadia.maestro.trascodingworkerthree.util.IpHandlingUtil;
 ...
 */
@ArcadiaComponent(
        componentname = "TrascodingWorkerThree",
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "trascodingworkerthree", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
     ...
     * @param chainingInfo ChainingInfo object
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "trascodingworkerthree")
