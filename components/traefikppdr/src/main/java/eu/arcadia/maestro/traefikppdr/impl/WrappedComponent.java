...
import eu.arcadia.maestro.traefikppdr.util.IpHandlingUtil;
...
@ArcadiaContainerParameter(
        key = "DockerCmd",
        value = "--consul --consul.endpoint=195.46.17.233:8500",
 ...
 */
@ArcadiaChainableEndpoint(CEPCID = "traefikppdr", allowsMultipleTenants = true)
public class WrappedComponent {
    ...
    */
    ...
    public static String getTraefikppdruri() {
    ...
    public static String getTraefikppdrport() {
     ...
     * @param chainingInfo ChainingInfo object
     */
    @ArcadiaChainableEndpointResolutionHandler(CEPCID = "traefikppdr")
